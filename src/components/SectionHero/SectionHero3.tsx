...
import backgroundLinePng from "@/images/BackgroundLine.png";
    ...
    >
      <div className="relative pt-8 lg:pt-0 lg:absolute z-10 inset-x-0 top-[10%] sm:top-[20%]  container">
        <div className="flex flex-col items-start max-w-lg xl:max-w-2xl space-y-5 xl:space-y-4 ">
          <span className="sm:text-md md:text-md font-normal text-gray-500 tracking-extraWide">
            ELEVATE YOUR BEAUTY ROUTINE
          </span>
          <h2 className="font-semibold text-gray-900 text-3xl sm:text-3xl md:text-3xl xl:text-3xl 2xl:text-3xl !leading-[115%] mt-0 tracking-Wide">
            Hair Rejuway Confidence With Our <br/>
            Exclusive Beauty Collection
          </h2>
          <h2 className="font-normal text-gray-600 sm:text-md md:text-md !leading-[115%] leading-4">
