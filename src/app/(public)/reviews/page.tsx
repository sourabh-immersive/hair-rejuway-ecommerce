...
const Page = async () => {
  // const refundPage = await getPageBySlug("return-refund-and-cancellation-policy");
  // const data: { title: string; slug: string; content: any } = refundPage && refundPage.data[0];
